...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'All notifications deleted successfully' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request - invalid preferences' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
